...
- macof -s <source_ip> -d <destination_ip> -e <dst_hw> -x <src_port> -y <dst_port> -i <interface>
- ex) macof -d 192.168.0.1 -i eth0
- urlsnarf -i <interface> -p <pcap_file> -v <reg_pattern>
...
- arpspoof -i <interface> -t <dest_ip> -r <gw_ip> -c 
...
- Rapid Reset : HTTP2의 RST_STREAM 패킷을 이용한 공격
