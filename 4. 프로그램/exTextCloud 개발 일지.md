...
- insert : question2 = Question(subject=forhttp://m.subject.data, content=forhttp://m.content.data, create_date=datetime.now(), realname=g.user.realname) \ db.session.add(question2)
